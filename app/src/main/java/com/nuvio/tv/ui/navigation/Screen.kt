...
sealed class Screen(val route: String) {
    ...
    data object IptvPlaylistManager : Screen("iptv_playlists")
    data object IptvAddEditPlaylist : Screen("iptv_add_edit_playlist?playlistId={playlistId}") {
        fun createRoute(playlistId: String? = null): String {
            return "iptv_add_edit_playlist?playlistId=${playlistId ?: ""}"
        }
    }
}
